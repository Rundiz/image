...
// resize 1
$Imagick = new \Imagick(realpath($source_image_png));
$Imagick->resizeImage($new_width1, $new_height1, \Imagick::FILTER_LANCZOS, 1);
$save_image_link = 'imagick-resize-900x600.png';
...
$save_image_link = 'imagick-resize-700x467.png';
$save_result = $Imagick->writeImage($processed_images_fullpath.$save_image_link);
var_dump($save_result);
echo '<a href="'.$processed_images_folder.$save_image_link.'">resized image</a>'."\n";
echo '<hr>'."\n\n";
...
$save_image_link = 'imagick-crop-460x460.png';
$save_result = $Imagick->writeImage($processed_images_fullpath.$save_image_link);
var_dump($save_result);
...
$save_image_link = 'imagick-crop-460x460-rotate.png';
$save_result = $Imagick->writeImage($processed_images_fullpath.$save_image_link);
$Imagick->clear();
var_dump($save_result);
...
$Imagick = new \Imagick(realpath($source_image_png));
$Imagick->resizeImage($new_width1, $new_height1, \Imagick::FILTER_LANCZOS, 1);
$save_image_link = 'imagick-resize-900x600-from-png.jpg';
$Imagick = $Imagick->mergeImageLayers(\Imagick::LAYERMETHOD_FLATTEN);// convert from transparent to white. for PNG source
$save_result = $Imagick->writeImage($processed_images_fullpath.$save_image_link);
var_dump($save_result);
echo '<a href="'.$processed_images_folder.$save_image_link.'">resized image</a>'."\n";
...
$save_image_link = 'imagick-resize-900x600-from-png.gif';
$save_result = $Imagick->writeImage($processed_images_fullpath.$save_image_link);
$Imagick->clear();
var_dump($save_result);
echo '<a href="'.$processed_images_folder.$save_image_link.'">resized image</a>'."\n";
