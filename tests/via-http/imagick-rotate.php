...
<html>
    ...
    <body>
        ...
        $rotate = 90;
        $file_name = '../processed-images/rundiz-imagick-image-rotate-testpage-'.$rotate.'degree.jpg';
        $Image->rotate($rotate);
        ...
        $rotate = 90;
        $file_name = '../processed-images/rundiz-imagick-image-rotate-testpage-'.$rotate.'degree.png';
        $Image->rotate($rotate);
        $Image->save($file_name);
        $Image->clear();
        echo '<a href="'.$file_name.'">'.$rotate.' degree</a><img src="'.$file_name.'" alt="" class="thumbnail"> ';
