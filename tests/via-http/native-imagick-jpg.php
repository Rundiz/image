            ...
            <tbody>
                <tr>
                    ...
                    foreach ($sizes as $size) {
                        ...
                        // save
                        $saveImgLink = basename(__FILE__, '.php') . '-resize-' . $size[0] . 'x' . $size[1] . (isset($previousSize[0]) ? '-from-' . $previousSize[0] . 'x' . $previousSize[1] : '') . '.jpg';
                ...
                <tr>
                    ...
                    <td>
                        ...
                        // save
                        $saveImgLink = basename(__FILE__, '.php') . '-crop-' . $cropWidth . 'x' . $cropHeight . '-from-' . $previousSize[0] . 'x' . $previousSize[1] . '.jpg';
                        $Imagick->setImageCompressionQuality(100);
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                    ...
                    <td>
                        ...
                        $Imagick->cropImage($cropWidth, $cropHeight, 0, 0);
                        // save
                        $saveImgLink = basename(__FILE__, '.php') . '-crop-' . $cropWidth . 'x' . $cropHeight . '-from-source-image.jpg';
                        $Imagick->setImageCompressionQuality(100);
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                        echo $cropWidth . 'x' . $cropHeight . '<br>' . PHP_EOL;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $saveImgLink = basename(__FILE__, '.php') . '-rotate-' . $deg . '-from-crop-' . $cropWidth . 'x' . $cropHeight . '-from-source-image.jpg';
                        $Imagick->setImageCompressionQuality(100);
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                    ...
                    <td>
                        ...
                        // rotate
                        $Imagick->rotateImage(new \ImagickPixel('rgba(255, 255, 255, 0)'), calculateCounterClockwise($deg));
                        $saveImgLink = basename(__FILE__, '.php') . '-rotate-' . $deg . '-from-source-image.jpg';
                        $Imagick->setImageCompressionQuality(100);
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $Imagick->resizeImage($size[0], $size[1], \Imagick::FILTER_LANCZOS, 1);
                        // save
                        $saveImgLink = basename(__FILE__, '.php') . '-resize-' . $size[0] . 'x' . $size[1] . '-from-jpg.png';
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                        echo $size[0] . 'x' . $size[1] . '<br>' . PHP_EOL;
                    ...
                    <td>
                        ...
                        $Imagick->resizeImage($size[0], $size[1], \Imagick::FILTER_LANCZOS, 1);
                        // save
                        $saveImgLink = basename(__FILE__, '.php') . '-resize-' . $size[0] . 'x' . $size[1] . '-from-jpg.gif';
                        $saveResult = $Imagick->writeImage($processImagesFullpath . $saveImgLink);
                        echo '<a href="' . $processImagesFolder  . $saveImgLink . '"><img class="thumbnail" src="' . $processImagesFolder  . $saveImgLink . '" alt=""></a><br>' . PHP_EOL;
                        echo $size[0] . 'x' . $size[1] . '<br>' . PHP_EOL;
                        echo 'Save result: ' . var_export($saveResult, true) . '<br>' . PHP_EOL;
