...
$base_save_file_name = '../processed-images/rundiz-imagick-image-resize-'.$resize_w.'x'.$resize_h.'-rotate-'.$rotate.'-crop-'.$crop_width.'x'.$crop_height;
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <h1>Imagick test multi process <small>resize <?php echo $resize_w.'x'.$resize_h; ?> &gt; rotate <?php echo $rotate; ?>&deg; &gt; crop <?php echo $crop_width.'x'.$crop_height; ?></small></h1>
        <h2>JPG</h2>
        <?php
        ...
        $file_ext = 'jpg';
        echo '<br>';
        $file_name = '../processed-images/rundiz-imagick-image-resize-'.$resize_w.'x'.$resize_h.'-crop-'.$crop_width.'x'.$crop_height.'-center,middle-rotate-'.$rotate.'-sourcejpg.'.$file_ext;
        $Image->resizeNoRatio($resize_w, $resize_h);
        ...
        $file_name = '../processed-images/rundiz-imagick-image'.'-crop-'.$crop_width.'x'.$crop_height.'-resize-'.$resize_w.'x'.$resize_h.'-rotate-'.$rotate.'-sourcejpg.'.$file_ext;
        $Image->crop($crop_width, $crop_height);
        $Image->resizeNoRatio($resize_w, $resize_h);
        $Image->rotate($rotate);
        $Image->save($file_name);
        ...
        $file_name = '../processed-images/rundiz-imagick-image'.'-crop-'.$crop_width.'x'.$crop_height.'-rotate-'.$rotate.'-resize-'.$resize_w.'x'.$resize_h.'-sourcejpg.'.$file_ext;
        $Image->crop($crop_width, $crop_height);
        $Image->rotate($rotate);
        $Image->resizeNoRatio($resize_w, $resize_h);
        $Image->save($file_name);
        ...
        $file_name = '../processed-images/rundiz-imagick-image'.'-rotate-'.$rotate.'-crop-'.$crop_width.'x'.$crop_height.'-resize-'.$resize_w.'x'.$resize_h.'-sourcejpg.'.$file_ext;
        $Image->rotate($rotate);
        $Image->crop($crop_width, $crop_height);
        $Image->resizeNoRatio($resize_w, $resize_h);
        $Image->save($file_name);
        ...
        $file_name = '../processed-images/rundiz-imagick-image'.'-rotate-'.$rotate.'-resize-'.$resize_w.'x'.$resize_h.'-crop-'.$crop_width.'x'.$crop_height.'-sourcejpg.'.$file_ext;
        $Image->rotate($rotate);
        $Image->resizeNoRatio($resize_w, $resize_h);
        $Image->crop($crop_width, $crop_height);
        $Image->save($file_name);
        ...
        $file_name = '../processed-images/rundiz-imagick-image-crop-900x900-crop-600x600-crop-'.$crop_width.'x'.$crop_height.'-crop-400x400-sourcejpg.'.$file_ext;
        $Image->crop(900, 900);
        $Image->crop(600, 600);
        $Image->crop($crop_width, $crop_height);
        $Image->crop(400, 400);
        ...
        $file_name = '../processed-images/rundiz-imagick-image'.'-rotate-'.$rotate.'-resize-'.$resize_w.'x'.$resize_h.'-crop-'.$crop_width.'x'.$crop_height.'-watermarkimage-right,bottom-sourcejpg.'.$file_ext;
        $Image->rotate($rotate);
        $Image->resizeNoRatio($resize_w, $resize_h);
        $Image->crop($crop_width, $crop_height);
        ...
        echo 'Save as: '."\n";
        $Image = new \Rundiz\Image\Drivers\Imagick($source_image_png);
        $file_ext = 'jpg';
        ...
        echo 'Save as: '."\n";
        $Image = new \Rundiz\Image\Drivers\Imagick($source_image_gif);
        $file_ext = 'jpg';
